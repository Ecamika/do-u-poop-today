...
const poopTips = [
	{
		content:
			'有些人在厕所里阅读，有些人在那里思考人生。而提利昂·兰尼斯特，在那里策划了他一半的胜利。',
		author: '乔治·R·R·马丁',
	},
	{
	...
	{
		content:
			'托马斯看着厕所的抽水马桶，认为这比任何形而上学都更令人安心——一按，所有的羞耻与负担都冲走了。',
		author: '米兰·昆德拉',
	},
	{
	...
	{
		content:
			'选择生活，选择工作，选择职业，选择家庭……选择坐在沙发上看电视，往嘴里塞垃圾食品，选择腐烂——到最后，你他妈连一泡像样的屎都拉不出来。',
		author: '《猜火车》',
	},
	{
		content:
			'人生就像一盒巧克力，你永远不知道下一颗是什么味儿。阿石也差不多——有时候顺畅，有时候得使出吃奶的劲儿。',
		author: '《阿甘正传》',
	},
]

function MainLayout({ children }: { children: JSX.Element[] }) {
	return <div className="w-screen flex flex-col items-center justify-start gap-8">{children}</div>
}
		...
		<div className="w-[80%]">
			<Card className="w-full flex-row">
				...
				<Card.Header className="h-full w-full">
					...
					<Card.Description>
						你今天的阿石次数是：
						<span className="font-bold text-xl">{shitTimes}次！</span>
					</Card.Description>
...
function ShitGreenWall() {
	...
	for (let i = 0; i < weeks; i++) {
		...
		for (let j = 0; j < 7; j++) {
			...
			weekCells.push(times >= 4 ? 4 : times)
				...
				<Modal.Backdrop>
					<Modal.Container placement="center">
						<Modal.Dialog>
							...
							<Modal.Body>
								<p>你已连续阿石{continuousShitTimes}天！</p>
								<p>坚持每天阿石！养成良好的阿石习惯！</p>
							</Modal.Body>
							<Modal.Footer>
			...
			<Card className="w-full flex-row">
				...
				<Card.Header>
					...
					{record === undefined || record.times === 0 ? (
						...
						<>
							<Card.Description>
								在这天你一共阿了 <span className="font-bold text-xl">{record.times}次！</span>
								😋😋😋
							</Card.Description>
						</>
					)}
