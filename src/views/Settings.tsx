...
function MainLayout({ children }: { children: JSX.Element[] }) {
  return (
    <div className="w-screen flex flex-col items-center justify-start gap-8 pt-8">
      {children}
    </div>
  )
}
...
function ClearShitTimeBtn() {
  ...
  return (
    <div className="w-[80%]">
      <Modal>
        <Button variant="danger" fullWidth className="font-bold">清空阿石记录</Button>
        <Modal.Backdrop>
          <Modal.Container placement="center">
            <Modal.Dialog>
              ...
              <Modal.Footer>
                <Button slot="close" variant="tertiary" fullWidth>我后悔了</Button>
                <Button
                  slot="close"
                  variant="danger-soft"
                  fullWidth
